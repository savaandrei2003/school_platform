    ...
    >
      <div style={{ padding: 16, borderBottom: "1px solid #eee" }}>
        ...
        <div style={{ marginTop: 6, fontSize: 12, opacity: 0.7 }}>
          Aici vezi <b>doar comenzile active</b> (PENDING / CONFIRMED). CANCELED nu se afișează.
      ...
      <div style={{ flex: 1, minHeight: 0, overflow: "auto", padding: 16, paddingRight: 12 }}>
        {visibleOrders.length === 0 ? (
          <div style={{ background: "#f7f7f7", border: "1px dashed #ddd", padding: 12, borderRadius: 12 }}>
            <div style={{ fontWeight: 900 }}>Nu există comenzi active pentru această zi.</div>
            <div style={{ fontSize: 12, opacity: 0.75, marginTop: 6 }}>
              Dacă ai anulat o comandă, ziua e considerată liberă (nu afișăm CANCELED).
            </div>
          </div>
        ) : (
                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", gap: 12, alignItems: "flex-start" }}>
                    ...
                    <div style={{ display: "flex", gap: 8, flexWrap: "wrap", justifyContent: "flex-end" }}>
                      <button
                        onClick={() => nav(`/menus/${selectedDay}?childId=${encodeURIComponent(o.childId)}`)}
                        disabled={!canUpdate}
                        style={{
                          padding: "10px 12px",
                          borderRadius: 12,
                        ...
                        title={
                          isPastDay(selectedDay)
                            ...
                            : "Modifică selecția pentru copilul ăsta"
                        }
                      >
                        Update
                      </button>
                      ...
                      <button
                        ...
                        title={
                          isPastDay(selectedDay)
                            ...
                            ? "După 09:00 nu se mai pot face modificări pentru azi"
                            : o.status !== "PENDING"
                            ? "Poți anula doar PENDING (înainte de cutoff)"
                            : "Anulează comanda"
                        }
                      >
                  ...
                  {/* ✅ felurile pe orizontală (2 coloane), fără să mănânce vertical */}
                  <div
                    style={{
                      marginTop: 12,
                      display: "grid",
                  ...
                  >
                    ...
                    {snap.some((x) => x.category === "RESERVE") ? (
                      ...
                      <div /> // păstrează grid-ul aliniat (opțional)
                    )}
                  </div>
                </div>
              );
